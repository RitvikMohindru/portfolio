...
function isCommitSelected(commit) {
    ...
    const min = { x: xScale.invert(brushSelection[0][0]), y: yScale.invert(brushSelection[1][1]) };
    const max = { x: xScale.invert(brushSelection[1][0]), y: yScale.invert(brushSelection[0][1]) };
